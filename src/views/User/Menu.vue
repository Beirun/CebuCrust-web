...
const adminMenuItems = ref([
  {
    ...
    isFavorite: true,
    isAvailable: true,
    ingredients: ['Pepperoni', 'Mozzarella', 'Tomato Sauce', 'Hand-tossed Dough'],
    preparationTime: 15,
    calories: 320,
    isVegetarian: false,
    isSpicy: false
  },
  {
    ...
    isFavorite: true,
    isAvailable: true,
    ingredients: ['Fresh Mozzarella', 'Vine-ripened Tomatoes', 'Basil', 'Thin Crust'],
    preparationTime: 12,
    calories: 280,
    isVegetarian: true,
    isSpicy: false
  },
  {
    ...
    isFavorite: true,
    isAvailable: true,
    ingredients: ['Pineapple', 'Ham', 'Mozzarella', 'Thin Crust'],
    preparationTime: 18,
    calories: 350,
    isVegetarian: false,
    isSpicy: false
  },
  {
    ...
    isFavorite: true,
    isAvailable: true,
    ingredients: ['Buffalo Chicken', 'Celery', 'Red Onions', 'Blue Cheese Sauce'],
    preparationTime: 20,
    calories: 420,
    isVegetarian: false,
    isSpicy: true
